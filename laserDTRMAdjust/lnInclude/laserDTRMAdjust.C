...
namespace Foam
{
    namespace radiation
    {
        defineTypeNameAndDebug(laserDTRMAdjust, 0);
        addToRadiationRunTimeSelectionTables(laserDTRMAdjust);
    }
...
const Foam::Enum<Foam::radiation::laserDTRMAdjust::powerDistributionMode>
Foam::radiation::laserDTRMAdjust::powerDistNames_
{
...
Foam::scalar Foam::radiation::laserDTRMAdjust::calculateIp(scalar r, scalar theta)
{
...
Foam::tmp<Foam::volVectorField> Foam::radiation::laserDTRMAdjust::nHatfv
(
...
void Foam::radiation::laserDTRMAdjust::initialiseReflection()
{
...
void Foam::radiation::laserDTRMAdjust::initialise()
{
        ...
        for (label ri = 0; ri < ndr_; ri++)
        {
            ...
            for (label thetai = 0; thetai < ndTheta_; thetai++)
            {
                ...
                if (cellI != -1)
                {
                    ...
                    DTRMParticle* pPtr =
                        new DTRMParticle(mesh_, p0, p1, Ip, cellI, dAi, -1, 0);
...
Foam::radiation::laserDTRMAdjust::laserDTRMAdjust(const volScalarField& T)
:
...
Foam::radiation::laserDTRMAdjust::laserDTRMAdjust
(
...
bool Foam::radiation::laserDTRMAdjust::read()
{
...
Foam::label Foam::radiation::laserDTRMAdjust::nBands() const
{
    return 1;
}


void Foam::radiation::laserDTRMAdjust::calculate()
{
...
Foam::tmp<Foam::volScalarField> Foam::radiation::laserDTRMAdjust::Rp() const
{
...
Foam::radiation::laserDTRMAdjust::Ru() const
{
